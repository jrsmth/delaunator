...
describe("Circle Tests", () => {
  ...
  ]).it('should find the center [%s] of the circle given three points on its circumference', (center, pointA, pointB, pointC) => {
    // given
  ...
  ]).it('should find circle radius [%s] given its center and three points on the circumference', (radius, center, pointA, pointB, pointC) => {
    // given
    let circle = new Circle();
